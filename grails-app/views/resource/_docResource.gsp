    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left: 15px;margin-right:15px">
                <g:form method="post" class="form-horizontal" enctype="multipart/form-data" controller="resource" action="upload">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <g:textArea rows="4" class="form-control pull-right" name="createDoc"/></div>
                    </div>
